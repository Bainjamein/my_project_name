...
/* post/post.html.twig */
class __TwigTemplate_0b22162bd26dee43d52ca452b04f0c22 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        echo " a pour titre  ";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 4, $this->source); })()), "getTitle", [], "any", false, false, false, 4), "html", null, true);
        echo " </h1>
...
";
    ...
    {% block body %}
        ...
        <h1>le post {{ post.id }} a pour titre  {{ post.getTitle }} </h1>
    
    
    
{% endblock %}", "post/post.html.twig", "/Users/benjamin/CESI/S1/Symfony/test/templates/post/post.html.twig");
    }
}
